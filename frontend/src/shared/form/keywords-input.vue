  ...
  <div class="app-keywords-input">
    ...
    >
      <span class="helper-copy">Press ENTER or comma (,) to separate
        keywords.</span>
      <el-popover v-if="signals" placement="top-start">
        <template #reference>
          <div
            class="flex items-center text-zinc-400 text-xs ml-2"
          >
            <i
        ...
        <div>
          ...
          <div class="text-2xs text-zinc-200 mb-4">
            Example: devtool
          </div>
          <div class="text-xs font-medium">
            Exact match
          </div>
          <div class="text-2xs text-zinc-200">
            Example: "devtool"
          </div>
        </div>
      </el-popover>
...
.app-keywords-input {
  ...
  .el-keywords-input-wrapper {
    @apply relative text-sm bg-black shadow-none border border-solid border-zinc-700 rounded-md pr-2 pl-1 flex items-center flex-wrap;
  ...
  .el-keywords-input {
    @apply bg-transparent border-none pl-0 ml-2 h-full text-white;
    font-size: inherit;
    outline: none;
    width: 400px;
    min-height: 24px;
