  ...
  <app-drawer v-model="isDrawerOpen" :title="title" size="600px">
    <template #content>
      <div class="-mx-6 -mt-4">
        ...
        <section class="border-y border-zinc-700 bg-zinc-900 py-4 px-6">
        ...
        <section class="px-6">
          <div class="py-6 flex items-center justify-between">
            ...
            <el-dropdown v-if="filterList.length > 0" placement="bottom-end">
              <p class="text-xs leading-5 font-medium text-white">
                Matching {{ form.relation === 'and' ? 'all' : 'any' }} <i class="ri-arrow-down-s-line" />
              </p>
              <template #dropdown>
                <el-dropdown-item
                  class="flex items-center justify-between"
                  :class="{ 'bg-orange-900': form.relation === 'and' }"
                  @click="form.relation = 'and'"
                >
                  Matching all
                  <i
                    :class="form.relation === 'and' ? 'opacity-100' : 'opacity-0'"
                    class="ri-check-line !text-orange-500 !mr-0 ml-1"
                  />
                </el-dropdown-item>
                <el-dropdown-item
                  class="flex items-center justify-between"
                  :class="{ 'bg-orange-900': form.relation === 'or' }"
          ...
          <div
            class="flex pb-10 border-b border-zinc-700 pt-1"
          >
            <el-dropdown placement="bottom-start" trigger="click" popper-class="!p-0">
              <p class="text-xs font-medium leading-5 text-orange-500">
                + Add filter
              </p>
              <template #dropdown>
                <div class="-m-2">
