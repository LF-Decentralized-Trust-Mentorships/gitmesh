      ...
      <div>
        <section class="pb-6">
          ...
          <p class="text-2xs text-gray-500">
            Define which gitmesh.dev core elements can be synced to or from HubSpot.
          </p>
        </section>
        ...
        <section class="pt-6">
          ...
          <div class="flex justify-between pb-5">
            <p class="text-2xs text-gray-500">
              Select and map which attributes and properties to sync between gitmesh.dev and HubSpot.
            </p>
            <div class="pl-8">
              <el-button
              ...
              <template #title>
                <div class="flex justify-between w-full items-center">
                  ...
                  <div
                    ...
                    :class="memberAttributesSynced > 0 ? 'text-brand-700 bg-brand-50' : 'text-gray-300 bg-gray-100'"
                  >
              ...
              <template #title>
                <div class="flex justify-between w-full items-center">
                  ...
                  <div
                    ...
                    class="h-5 px-2 rounded-full text-3xs flex items-center"
                    :class="organizationAttributesSynced > 0 ? 'text-brand-700 bg-brand-50' : 'text-gray-300 bg-gray-100'"
                  >
...
const hubspotDetails = computed(() => GitmeshIntegrations.getConfig('hubspot'));
...
onMounted(() => {
  ...
  const data = GitmeshIntegrations.getMappedConfig('hubspot', store);
...
.c-select{
  @apply w-full h-8 bg-gray-50 border border-gray-100 rounded-md px-2 text-2xs text-gray-300;
}
</style>
