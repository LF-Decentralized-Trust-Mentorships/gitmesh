  ...
  >
    <template #header>
      <div class="flex gap-4">
        ...
        <p class="text-sm text-gray-500 font-medium mt-1">
          The following attributes, auto-generated by gitmesh.dev, are only mapped into HubSpot,
    ...
    <template #content>
      <section class="px-6 pb-4 -mt-2">
        <ul class="mx-18 mb-4 text-gray-200 font-semibold text-sm list-disc">
      ...
      <footer class="flex justify-between py-4 px-6 items-center bg-gray-100 rounded-b-md">
        ...
        >
          <span class="text-xs text-gray-200">Don't show this message again</span>
        </el-checkbox>
        <div>
          <el-button
