<template>
  ...
  >
    <template #beforeTitle>
      <img class="w-14 h-14 mr-2" :src="logoUrl" alt="n8n logo" />
    </template>
    <template #content>
      <div class="flex flex-row items-center justify-between w-full">
        <p class="font-bold text-base">
          Set up gitmesh.dev in n8n
        </p>
        <a
      ...
      <div class="container flex flex-row w-full items-start py-10">
        <ul class="list-none space-y-4">
          <li class="flex items-start">
            <span
              class="flex-none w-8 h-8 flex justify-center items-center rounded-full bg-gray-300 text-gray-200 font-bold text-sm"
            >1</span>
            <p class="ml-4 text-gray-200 text-xs">
          ...
          <li class="flex items-start">
            ...
            <p class="ml-4 text-gray-200 text-xs">
              Go to
              <a
                href="https://n8n.io/integrations/gitmesh/"
                target="_blank"
                rel="noopener noreferrer"
                class="underline underline-offset-4"
              >n8n</a>
          ...
          <li class="flex items-center">
            ...
            <p class="ml-4 text-gray-200 text-xs">
              ...
              <a
                href="https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.gitmesh/"
                target="_blank"
                rel="noopener noreferrer"
                class="underline underline-offset-4"
              >supported
...
const logoUrl = GitmeshIntegrations.getConfig('n8n').image;
