    ...
    <template #content>
      ...
      >
        <div class="flex flex-col items-start gap-2">
          ...
          <span class="text-2xs font-light text-zinc-400">
...
const logoUrl = GitmeshIntegrations.getConfig('stackoverflow').image;
...
const connect = async () => {
  try {
    // Skip Nango OAuth for now - Stack Overflow integration works without it
    // TODO: Set up Stack Exchange OAuth in Nango if user authentication is needed
    ...
    console.error(e);
    Message.error('Failed to connect Stack Overflow integration');
  }
};
