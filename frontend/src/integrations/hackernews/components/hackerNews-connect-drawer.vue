  ...
  >
    ...
    <template #content>
      <div class="flex flex-col gap-2 items-start mb-2">
        <span class="text-xs font-light mb-2 text-white">
        ...
        <app-keywords-input
          v-model="keywords"
          placeholder="e.g. gitmesh.dev, gitmeshdev, LF-Decentralized-Trust-labs"
        />
      </div>
        ...
        <div class="flex flex-col gap-2 items-start">
          ...
          >
            ...
            >
              ...
              >
                <template #prepend>
                  <span class="font-light text-zinc-300">https://</span>
                </template>
              </el-input>
              <el-button
                v-if="!isLastUrl"
...
export default {
  ...
  data() {
    return {
      logoUrl:
        GitmeshIntegrations.getConfig('hackernews').image,
      users: [],
      urls: [],
      keywords: [],
      loading: false,
