<template>
  <app-page-wrapper size="narrow">
    <router-link
      class="text-gray-300 btn-link--md btn-link--secondary p-0 inline-flex items-center mt-1 mb-4"
    ...
    <div class="text-xs text-gray-300 pb-6">
      gitmesh.dev is constantly checking your community for duplicate organizations.
    ...
    <div v-else class="pt-20 flex flex-col items-center">
      ...
      <p class="text-sm text-center text-gray-300 leading-5">
