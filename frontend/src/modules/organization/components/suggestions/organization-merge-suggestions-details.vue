  ...
  <section v-else class="h-full">
    ...
    >
      ...
      <div class="h-13 flex justify-between items-start">
        ...
        >
          <span class="ri-arrow-left-right-fill text-base text-gray-300 mr-2" />
      ...
      <div class="pb-4">
        ...
        <div>
          ...
          <div
            ...
            ref="bio"
            class="text-gray-300 leading-5 !text-xs merge-member-bio"
      ...
      <div>
        ...
        >
          ...
          <a
            ...
            class="text-xs text-gray-200 text-right"
        ...
        >
          <p class="text-2xs font-medium text-gray-200 pr-4">
            Location
          </p>
        ...
        >
          ...
          <p class="text-xs text-gray-200 text-right first-letter:uppercase">
            {{ props.organization.industry || '-' }}
          </p>
        </article>
        <article
      ...
      <div class="pt-5">
        <template v-if="props.organization.identities && props.organization.identities.length > 0">
          <a
            ...
            :key="ii"
            class="py-2 flex items-center relative text-gray-200 transition-colors"
        ...
        <a
          ...
          :key="email"
          class="py-2 flex items-center relative hover:text-brand-500 transition-colors cursor-pointer text-gray-200"
          :href="`mailto:${email}`"
          target="_blank"
          rel="noopener noreferrer"
        >
