              ...
              >
                    ...
                    >
                      <div class="mr-4">
                        <span
                          ...
                          class="text-sm h-full flex items-center text-zinc-200"
                        >
                ...
                >
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-zinc-200 text-sm h-full flex items-center"
                      >
                        {{
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.location" class="text-zinc-200">
                          {{
                            scope.row.location
                          }}
                        </span>
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.industry" class="text-zinc-200">
                          {{
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.size" class="text-zinc-200">
                          {{
                            scope.row.size
                          }}
                        </span>
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.type" class="text-zinc-200">
                          {{
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.founded" class="text-zinc-200">
                          {{
                            scope.row.founded
                          }}
                        </span>
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.employeeChurnRate?.['12_month']" class="text-zinc-200">
                          {{
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.employeeGrowthRate?.['12_month']" class="text-zinc-200">
                          {{
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.employees" class="text-zinc-200">
                          {{
                            scope.row.employees
                          }}
                        </span>
                  ...
                  <template #default="scope">
                    ...
                    >
                      <div
                        class="text-sm h-full flex items-center"
                      >
                        <span v-if="scope.row.revenueRange" class="text-zinc-200">
                          {{
