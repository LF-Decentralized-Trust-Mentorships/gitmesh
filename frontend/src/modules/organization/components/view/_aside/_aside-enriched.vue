<template>
  <div>
    <div
      ...
      class="last:border-0"
      :class="{
        'py-3 border-b border-zinc-700': organization[attribute.name],
      }"
    >
      <div
      ...
      >
        <div
          class="text-zinc-200 font-medium text-2xs"
        >
          {{ attribute.label }}
        </div>
        ...
        <component
          ...
          item-class="border border-zinc-700 px-1.5 text-xs rounded-md h-fit text-zinc-200 m-1 inline-flex break-keep"
        ...
        />
        <div v-else class="mt-1 text-zinc-200 text-xs">
