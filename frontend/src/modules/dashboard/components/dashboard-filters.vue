<template>
  <div
    class="flex items-center py-4 border-y border-zinc-700 justify-between"
  >
    <!-- period filters -->
    <app-widget-period
      :period="period"
    ...
    >
      <el-button
        class="btn btn--bordered bg-zinc-900 !py-1.5 !px-3 outline-none"
      >
        <div class="flex items-center text-xs">
          <i
            class="ri-apps-2-line text-base text-zinc-100 mr-2"
          />
          <span class="font-medium text-zinc-100">Platform:</span>
          <span class="text-zinc-400 pl-1">{{
            getPlatformName
          }}</span>
        </div>
      </el-button>
      ...
      <template #dropdown>
        <el-dropdown-menu class="w-42">
          <!-- all platforms -->
          <el-dropdown-item
            :class="{ 'bg-brand-900': platform === 'all' }"
          ...
          <el-dropdown-item
            ...
            :divided="ii === 0"
            :class="{
              'bg-brand-900': platform === integration,
            }"
