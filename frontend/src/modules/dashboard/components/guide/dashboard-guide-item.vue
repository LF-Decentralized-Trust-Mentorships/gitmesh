  ...
  <article>
    ...
    <div class="pb-1">
      <div
        ...
        "
        class="relative rounded bg-zinc-800 mb-4 w-full h-20 flex items-center justify-center bg-cover group cursor-pointer"
        :style="{
      ...
      <p class="text-xs text-zinc-400 leading-5 mb-4">
        {{ props.guide.body }}
      </p>
