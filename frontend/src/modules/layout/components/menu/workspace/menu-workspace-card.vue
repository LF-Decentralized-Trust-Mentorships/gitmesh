<template>
  <section v-if="props.tenant" class="transition flex items-center cursor-pointer">
    <div class="flex items-center justify-between overflow-hidden w-full" :class="{ 'justify-center': props.collapsed }">
      <div class="flex items-center">
        ...
        <div v-if="!props.collapsed" class="pl-3">
          <h6 class="text-sm leading-4 !font-medium mb-1 text-white whitespace-nowrap">
            {{ props.tenant.name }}
          </h6>
