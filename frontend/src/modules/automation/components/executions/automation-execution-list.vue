<template>
  <div>
    <header class="py-2 border-b border-zinc-700 flex items-center">
      <div class="w-20">
        <p
          class="text-2xs leading-5 uppercase font-semibold tracking-1 text-zinc-200"
        >
          Type
        </p>
      </div>
    ...
    <div v-else-if="executions.length > 0">
      <article v-for="execution of executions" :key="execution.id" class="border-b border-zinc-700 py-3 flex items-center">
        <div class="w-20">
