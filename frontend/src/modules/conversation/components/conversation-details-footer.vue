  ...
  <app-conversation-footer-wrapper :conversation="conversation">
    ...
    >
      ...
      >
        ...
        >
          <i
            class="ri-group-line text-base mr-2 text-zinc-400"
          />
          <p
            class="text-xs text-zinc-100"
          >
        ...
        >
          <i
            :class="`${replyContent.pngn} text-base mr-2 text-zinc-400`"
          />
          <p
            class="text-xs text-zinc-100"
          >
      ...
      <div v-if="platformConfig?.conversationDisplay?.showLabels && attributes.labels?.length" class="mt-5">
        ...
        <div class="flex items-center flex-wrap gap-3">
          <div
            ...
            :key="label"
            class="h-8 rounded-lg text-zinc-100 border border-zinc-700 bg-zinc-900 text-xs flex items-center px-3"
          >
            {{ label }}
          </div>
        </div>
