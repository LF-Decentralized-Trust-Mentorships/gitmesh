<template>
  <article
    ...
    :key="`${plat}-${type}`"
    class="border-t border-zinc-700 py-4 flex items-center justify-between first:border-none"
  >
    <div class="flex items-center">
      ...
      <p class="text-xs leading-5 activity-type first-letter:uppercase text-zinc-100">
...
const getPlatformDetails = (plat) => GitmeshIntegrations.getConfig(plat);
