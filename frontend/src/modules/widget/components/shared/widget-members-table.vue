    ...
    >
      ...
      >
        ...
        <div class="flex flex-col">
          <span class="font-medium text-xs text-gray-200" v-html="$sanitize(member.displayName)" />
          <span
      ...
      <div
        class="inline-flex items-center justify-end mr-4 invisible group-hover:visible font-medium text-2xs text-gray-300 gap-1 col-start-8"
      >
...
const tooltipContent = (platform) => {
  const config = GitmeshIntegrations.getConfig(platform) || {};
