          ...
          >
            <div class="p-6">
              ...
              >
                <button
                  type="button"
                  class="inline-flex items-center leading-none mt-2 text-xs text-gray-300 font cursor-pointer hover:text-gray-200"
              ...
              <el-collapse-item name="chart" :disabled="loading">
                <template #title>
                  <div class="px-6">
                    ...
                    <i v-if="loading" class="ri-loader-4-line animate-spin text-gray-200 w-4 ml-2" />
                  </div>
                </template>
                <div
...
.widget-cube-builder {
  .el-drawer__body {
    ...
    .el-collapse-item:not(.is-disabled) {
      .preview-collapse {
        @apply text-2xs uppercase cursor-pointer text-gray-300;
