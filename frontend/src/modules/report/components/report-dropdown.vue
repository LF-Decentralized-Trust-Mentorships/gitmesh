<template>
  ...
  <div v-else>
    ...
    >
      <button
        class="el-dropdown-link btn p-1.5 rounder-md hover:bg-zinc-700 text-zinc-400"
        type="button"
        @click.stop
      >
...
export default {
  ...
  methods: {
    ...
    async copyToClipboard(value) {
      ...
      const url = `${window.location.origin}/tenant/${tenantId}/devtel/${value}/public`;
