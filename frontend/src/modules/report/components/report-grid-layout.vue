  ...
  >
    ...
    <div v-else>
      <div
        ...
        class="text-zinc-100 flex flex-col items-center justify-center rounded border border-dashed border-zinc-700 p-12 mx-4 my-8"
      >
        <i class="ri-bar-chart-line ri-6x text-zinc-700" />
