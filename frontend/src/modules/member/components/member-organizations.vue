<template>
  <div v-if="orientation === 'vertical'">
    <div v-if="activeOrganization">
      ...
      >
        ...
        <div class="max-w-full">
          <p
            class="text-gray-200 text-sm text-ellipsis truncate hover:text-brand-500 transition leading-relaxed"
          >
    ...
    >
      <p class="text-gray-200 text-ellipsis truncate">
        -
      </p>
      <div
  ...
  >
    <span
      ...
      class="text-gray-300 text-2xs mr-2 truncate block mt-0.5"
    >{{ member.attributes.jobTitle.default }}
