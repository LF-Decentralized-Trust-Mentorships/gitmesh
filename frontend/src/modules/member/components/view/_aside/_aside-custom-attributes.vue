<template>
  <div class="member-view-custom-attributes">
    ...
    <div
      ...
      class="py-3 text-zinc-200 text-xs italic"
    >
      ...
      >
        ...
        >
          <app-member-custom-attributes-array-renderer
            ...
            item-class="border border-zinc-700 px-2.5 text-xs py-1 rounded-md h-fit text-zinc-200 m-1 inline-flex break-keep"
          >
...
.member-view-custom-attributes {
  .attribute {
    @apply py-3 border-b border-zinc-700;
    &:last-of-type {
      @apply border-none;
    }
    .title {
      @apply text-zinc-200 font-medium text-2xs;
    }
    .value {
      @apply mt-1 text-zinc-200 text-xs;
    }
  }
}
</style>
