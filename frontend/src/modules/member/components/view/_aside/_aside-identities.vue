<template>
  <div>
    ...
    <div
      ...
      class="mt-2"
    >
      <el-divider class="border-t-zinc-700" />
      <div class="mt-4">
        <a
          v-for="(email, index) of emails"
          :key="email"
          class="py-2 px-6 -mx-6 flex justify-between items-center relative hover:bg-zinc-800 transition-colors cursor-pointer"
          :href="`mailto:${email}`"
          target="_blank"
        ...
        >
          ...
          >
            ...
            >
              ...
              <span ref="emailRef" class="text-zinc-200 text-xs truncate">
                {{ email }}</span>
            </div>
          </el-tooltip>
          <i
