  ...
  <div class="pt-6 pb-4">
    <div class="flex justify-between pb-6">
      <div class="flex text-xs text-zinc-400">
        <div
          v-for="(t, ti) of tabs"
          :key="t.name"
          class="px-3 h-8 border border-zinc-700 flex items-center justify-center transition hover:bg-zinc-800 cursor-pointer"
          :class="[
            tabClasses(t.name),
            {
    ...
    <div>
      ...
      <div v-else>
        ...
        >
          <div
            class="ri-checkbox-multiple-blank-line text-3xl text-zinc-600 flex items-center h-10"
          />
          <p class="pl-6 text-sm text-zinc-200 italic">
            {{ tab.emptyText }}
          </p>
        </div>
      </div>
