    ...
    <div class="pt-4 px-6 flex justify-between text-center">
      <div class="flex align-center">
        <img
          ...
          class="h-5 w-5 mr-2"
        />
        <span class="font-medium text-zinc-100 mr-2"> Open source contributions </span>
        ...
        <el-tooltip placement="top">
          ...
          <span class="ri-question-line text-base text-zinc-200" />
        </el-tooltip>
      </div>

      <div class="text-zinc-200 flex align-center italic text-2xs h-5">
        <el-tooltip
          placement="top"
        ...
        >
          <p>
            <i
              class="ri-checkbox-blank-circle-fill text-zinc-600 pr-2 my-auto cursor-default"
            />
    ...
    <div class="background-dotted rounded-lg h-64">
      ...
      >
        <div class="section mx-4">
          ...
          <p class="break-words font-medium text-zinc-100">
        ...
        <div class="pt-4 mx-4">
          <button
            type="button"
            class="text-zinc-300 text-sm w-full text-center my-auto bg-zinc-800 rounded-lg h-8 py-2 btn"
...
function edgeColor(edge) {
  ...
  return sharedTopics ? '#1A59E8' : '#F6B9AB';
}
...
.tooltip {
  ...
  position: absolute;
  z-index: 100000000;
  @apply bg-zinc-900 shadow-lg rounded-lg py-4 px-0 cursor-auto w-60 overflow-hidden;
}
...
.edge-tooltip {
  ...
  position: absolute;
  z-index: 100000000;
  @apply bg-zinc-900 text-sm shadow-lg rounded-lg p-2  w-60 cursor-auto;
}
...
.section {
  @apply pb-2 border-zinc-700;
}

.key {
  @apply text-zinc-200 text-xs font-medium py-2;
}

.topic {
  @apply border bg-zinc-800 border-zinc-700 text-zinc-300 rounded-lg px-2 py-1 text-xs mr-2 mb-2 h-8;
}
</style>
