<template>
  <div class="member-engagement-level-wrapper">
    <div class="leading-none">
      ...
      <div
        v-else-if="member.attributes.isTeamMember?.gitmesh"
      >
        <span
...
.member-engagement-level {
  @apply inline-flex items-center text-xs leading-none bg-gray-600 pr-1.5 border-0 gap-1.5 rounded-md text-gray-200;
