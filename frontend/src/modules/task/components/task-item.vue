<template>
  <article
    ...
    class="pt-6 pb-5 border-t border-zinc-700"
  >
    <div class="flex">
  ...
  <article
    v-else
    class="pt-6 pb-5 border-t border-zinc-700 task"
    :class="{ closing }"
  >
    <div class="flex">
      <div v-if="!hideCheck" class="pr-5">
        ...
        >
          <div
            class="ri-checkbox-circle-fill h-6 flex items-center text-xl text-zinc-200 hover:text-white transition cursor-pointer"
        ...
        >
          ...
          >
            <div
              class="ri-checkbox-blank-circle-line h-6 flex items-center text-xl text-zinc-600"
            />
            <div
              class="ri-checkbox-circle-line h-6 flex items-center text-xl absolute top-0 left-0 transition opacity-0 group-hover:opacity-100 text-orange-500"
            />
          </div>
        </el-tooltip>
      </div>
      ...
      >
        ...
        <div
          ref="taskBody"
          class="text-2xs leading-4.5 text-zinc-400 pt-1 c-content"
          :class="{
        ...
        <div
          ...
          class="text-2xs text-orange-500 mt-3 cursor-pointer"
        ...
        >
          <p
            class="text-2xs font-semibold leading-5 text-zinc-200 pr-3 mb-1"
          >
            Related member(s):
          </p>
          <router-link
            ...
            class="mr-2 mb-1 bg-zinc-900 border group border-zinc-700 rounded-md h-6 flex items-center px-1.5 cursor-pointer hover:border-zinc-600"
          >
            <app-avatar
              :entity="member"
              size="xxs"
            ...
            />
            <p
              class="text-2xs leading-4 text-white group-hover:text-orange-500 transition"
            >
              {{ member.displayName }}
            </p>
          </router-link>
        ...
        <div class="flex pt-4 items-center">
          <div class="pr-3 flex items-center">
            ...
            >
              ...
              />
              <p class="pl-2 text-2xs leading-4 text-zinc-300">
                {{
                  assignee.fullName
