      ...
      <CardContent className="pt-6 px-5 pb-5">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-medium text-gitmesh-elements-textPrimary font-mono">{model.name}</h4>
            ...
            <div className="flex items-center gap-4 text-xs text-gitmesh-elements-textSecondary">
        ...
        {model.progress && (
          <div className="mt-3 space-y-2">
            <div className="flex justify-between text-xs text-gitmesh-elements-textSecondary">
