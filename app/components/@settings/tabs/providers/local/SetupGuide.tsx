    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button
          ...
          size="sm"
          onClick={onBack}
          className="bg-transparent hover:bg-transparent text-gitmesh-elements-textSecondary hover:text-gitmesh-elements-textPrimary transition-all duration-200 p-2"
          aria-label="Back to Dashboard"
        >
          <ArrowLeft className="w-4 h-4" />
        </Button>
        <div>
          <h2 className="text-xl font-semibold text-gitmesh-elements-textPrimary">Local Provider Setup Guide</h2>
        ...
        <CardContent className="pt-8 px-6 pb-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gitmesh-elements-textSecondary">NVIDIA RTX 30xx+ or AMD RX 6000+</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gitmesh-elements-background-depth-1 shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-gitmesh-elements-textPrimary flex items-center gap-2">
            ...
            <div className="p-4 rounded-lg bg-gitmesh-elements-background-depth-3 border border-gitmesh-elements-borderColor">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
              ...
              <div className="mt-3 p-3 rounded-lg bg-gitmesh-elements-background-depth-4 border border-gitmesh-elements-borderColor">
                ...
                <p className="text-xs text-gitmesh-elements-textSecondary">
                  ...
                  <code className="bg-gitmesh-elements-background-depth-4 px-1 rounded">http://localhost:11434</code>
                </p>
              </div>
            </div>

            {/* CLI Installation */}
            <div className="p-4 rounded-lg bg-gitmesh-elements-background-depth-3">
              <div className="flex items-center gap-2 mb-3">
                <Terminal className="w-5 h-5 text-gitmesh-elements-textPrimary" />
                <h5 className="font-medium text-gitmesh-elements-textPrimary">Command Line (Advanced)</h5>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-gitmesh-elements-textPrimary" />
                    <strong className="text-gitmesh-elements-textPrimary">Windows</strong>
                  </div>
                  <div className="text-xs bg-gitmesh-elements-background-depth-4 p-2 rounded font-mono text-gitmesh-elements-textPrimary">
                ...
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Terminal className="w-4 h-4 text-gitmesh-elements-textPrimary" />
                    <strong className="text-gitmesh-elements-textPrimary">Linux</strong>
                  </div>
                  <div className="text-xs bg-gitmesh-elements-background-depth-4 p-2 rounded font-mono text-gitmesh-elements-textPrimary">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-gitmesh-elements-background-depth-3">
                <h5 className="font-medium text-gitmesh-elements-textPrimary mb-3 flex items-center gap-2">
                  <Code className="w-4 h-4 text-green-500" />
                  Code & Development
                </h5>
                <div className="space-y-2 text-xs bg-gitmesh-elements-background-depth-4 p-3 rounded font-mono text-gitmesh-elements-textPrimary">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                ...
                <ul className="text-xs text-gitmesh-elements-textSecondary space-y-1">
            ...
            <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-gitmesh-elements-textSecondary space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                ...
                <div className="text-xs bg-gitmesh-elements-background-depth-4 p-3 rounded font-mono text-gitmesh-elements-textPrimary space-y-1">
      ...
      <Card className="bg-gitmesh-elements-background-depth-1 shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-gitmesh-elements-background-depth-3">
                <h5 className="font-medium text-gitmesh-elements-textPrimary mb-2">Start Local Server</h5>
                <ol className="text-xs text-gitmesh-elements-textSecondary space-y-1 list-decimal list-inside">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <div className="space-y-2">
                  <p className="text-xs text-gitmesh-elements-textSecondary">
                    To work with gitmesh DIY, you MUST enable CORS in LM Studio:
                  </p>
                  <ol className="text-xs text-gitmesh-elements-textSecondary space-y-1 list-decimal list-inside ml-2">
                    <li>In Server Settings, check "Enable CORS"</li>
                    <li>Set Network Interface to "0.0.0.0" for external access</li>
                    <li>
                      Alternatively, use CLI:{' '}
                      <code className="bg-gitmesh-elements-background-depth-4 px-1 rounded">
      ...
      <Card className="bg-gitmesh-elements-background-depth-1 shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-gitmesh-elements-background-depth-3">
                <h5 className="font-medium text-gitmesh-elements-textPrimary mb-2">Quick Install</h5>
                <div className="text-xs bg-gitmesh-elements-background-depth-4 p-3 rounded font-mono text-gitmesh-elements-textPrimary space-y-1">
              ...
              <div className="p-4 rounded-lg bg-gitmesh-elements-background-depth-3">
                <h5 className="font-medium text-gitmesh-elements-textPrimary mb-2">Docker (Recommended)</h5>
                <div className="text-xs bg-gitmesh-elements-background-depth-4 p-3 rounded font-mono text-gitmesh-elements-textPrimary space-y-1">
      ...
      <Card className="bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor">
        <CardHeader className="pt-6 px-6 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gitmesh-elements-textSecondary">Tips to improve local AI performance</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <h4 className="font-medium text-gitmesh-elements-textPrimary">Hardware Optimizations</h4>
              <ul className="text-sm text-gitmesh-elements-textSecondary space-y-2">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-gitmesh-elements-textPrimary">Software Optimizations</h4>
              <ul className="text-sm text-gitmesh-elements-textSecondary space-y-2">
                <li className="flex items-start gap-2">
      ...
      <Card className="bg-gitmesh-elements-background-depth-1 shadow-sm">
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-medium text-gitmesh-elements-textPrimary">Other Local Solutions</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Package className="w-4 h-4 text-blue-500" />
                    <span className="font-medium text-gitmesh-elements-textPrimary">Jan.ai</span>
                  </div>
                  <p className="text-xs text-gitmesh-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-gitmesh-elements-textPrimary">Oobabooga</span>
                  </div>
                  <p className="text-xs text-gitmesh-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-gitmesh-elements-textPrimary">KoboldAI</span>
                  </div>
                  <p className="text-xs text-gitmesh-elements-textSecondary">
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-gitmesh-elements-textPrimary">Cloud Alternatives</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Globe className="w-4 h-4 text-orange-500" />
                    <span className="font-medium text-gitmesh-elements-textPrimary">OpenRouter</span>
                  </div>
                  <p className="text-xs text-gitmesh-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-gitmesh-elements-textPrimary">Together AI</span>
                  </div>
                  <p className="text-xs text-gitmesh-elements-textSecondary">Fast inference with open-source models</p>
                </div>
                <div className="p-3 rounded-lg bg-gitmesh-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Activity className="w-4 h-4 text-pink-500" />
                    <span className="font-medium text-gitmesh-elements-textPrimary">Groq</span>
                  </div>
                  <p className="text-xs text-gitmesh-elements-textSecondary">
