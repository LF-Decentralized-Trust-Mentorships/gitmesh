                  ...
                  <CardContent className="pt-6 px-6 pb-6 space-y-4">
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        <PackageOpen className="w-16 h-16 mx-auto text-gitmesh-elements-textTertiary mb-4" />
                ...
                <Card className="mt-4 bg-gitmesh-elements-background-depth-1 border border-gitmesh-elements-borderColor">
                  ...
                  <CardContent className="pt-6 px-6 pb-6 space-y-4">
                    {isLoadingLMStudioModels ? (
                      ...
                      <div className="text-center py-8">
                        <Monitor className="w-16 h-16 mx-auto text-gitmesh-elements-textTertiary mb-4" />
                        <h3 className="text-lg font-medium text-gitmesh-elements-textPrimary mb-2">
                          No Models Available
                        </h3>
                        <p className="text-sm text-gitmesh-elements-textSecondary mb-4">
