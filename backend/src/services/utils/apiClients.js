...
var config = conf_1.SEARCH_SYNC_API_CONFIG;
var searchSyncApiClient;
var getSearchSyncApiClient = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (!searchSyncApiClient) {
            searchSyncApiClient = new opensearch_1.SearchSyncApiClient(config);
        }
        return [2 /*return*/, searchSyncApiClient];
    });
}); };
