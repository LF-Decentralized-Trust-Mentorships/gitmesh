...
import { MemberAttributeName, PlatformType, SegmentStatus } from '@gitmesh/types'
...
import { GITHUB_MEMBER_ATTRIBUTES, TWITTER_MEMBER_ATTRIBUTES } from '@gitmesh/integrations'
  ...
  describe('createWithMember method', () => {
    it('Create an activity with given member [no parent activity]', async () => {
      ...
      const data = {
        ...
        channel: 'https://github.com/alveoli-app/gitmesh',
