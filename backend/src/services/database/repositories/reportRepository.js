...
var ReportRepository = /** @class */ (function () {
    ...
    ReportRepository.create = function (data, options) {
        return __awaiter(this, void 0, void 0, function () {
            var currentUser, tenant, transaction, segmentId, record;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        segmentId = data.noSegment
                            ? null
                            : sequelizeRepository_1["default"].getStrictlySingleActiveSegment(options).id;
                        return [4 /*yield*/, options.database.report.create(__assign(__assign({}, lodash_1["default"].pick(data, ['name', 'public', 'importHash', 'isTemplate', 'viewedBy'])), { tenantId: tenant.id, segmentId: segmentId, createdById: currentUser.id, updatedById: currentUser.id }), {
                                transaction: transaction
                            })];
                    case 1:
                        record = _a.sent();
                        return [4 /*yield*/, record.setWidgets(data.widgets || [], {
                                transaction: transaction
                            })];
                    case 2:
                        _a.sent();
    ...
    ReportRepository.update = function (id, data, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, options.database.report.findOne({
                                where: __assign({ id: id, tenantId: currentTenant.id }, ReportRepository.prepareSegmentFilter(options)),
                                transaction: transaction
                            })];
                    case 1:
                        record = _a.sent();
                        ...
                        return [4 /*yield*/, record.update(__assign(__assign({}, lodash_1["default"].pick(data, ['name', 'public', 'importHash', 'isTemplate', 'viewedBy'])), { updatedById: currentUser.id }), {
                                transaction: transaction
                            })];
                    case 2:
                        record = _a.sent();
                        if (!data.widgets) return [3 /*break*/, 4];
                        return [4 /*yield*/, record.setWidgets(data.widgets || [], {
                                transaction: transaction
                            })];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this._createAuditLog(auditLogRepository_1["default"].UPDATE, record, data, options)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/, this.findById(record.id, options)];
                }
    ...
    ReportRepository.destroy = function (id, options, force) {
    ...
    ReportRepository.findById = function (id, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ReportRepository.filterIdInTenant = function (id, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
    ...
    ReportRepository.filterIdsInTenant = function (ids, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, options.database.report.findAll({
                                attributes: ['id'],
                                where: where
                            })];
                    case 1:
    ...
    ReportRepository.count = function (filter, options) {
        return __awaiter(this, void 0, void 0, function () {
            var transaction, tenant;
            return __generator(this, function (_a) {
                transaction = sequelizeRepository_1["default"].getTransaction(options);
                tenant = sequelizeRepository_1["default"].getCurrentTenant(options);
                return [2 /*return*/, options.database.report.count({
                        where: __assign(__assign(__assign({}, filter), { tenantId: tenant.id }), ReportRepository.prepareSegmentFilter(options)),
                        transaction: transaction
                    })];
            });
        });
    };
    ReportRepository.findAndCountAll = function (_a, options) {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, options.database.report.findAndCountAll(__assign(__assign(__assign({}, (parsed.where ? { where: parsed.where } : {})), (parsed.having ? { having: parsed.having } : {})), { order: parsed.order, limit: parsed.limit, offset: parsed.offset, include: include, transaction: sequelizeRepository_1["default"].getTransaction(options) }))];
                    case 1:
    ...
    ReportRepository.findAllAutocomplete = function (query, limit, options) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        whereAnd = [
                            ...
                            __assign({}, ReportRepository.prepareSegmentFilter(options)),
                        ];
                        if (query) {
                            whereAnd.push((_a = {},
    ...
    ReportRepository._createAuditLog = function (action, record, data, options) {
        return __awaiter(this, void 0, void 0, function () {
            var values;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        values = {};
                        if (data) {
                            values = __assign(__assign({}, record.get({ plain: true })), { widgetsIds: data.widgets });
                        }
    ...
    ReportRepository._populateRelationsForRows = function (rows, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                if (!rows) {
    ...
    ReportRepository._populateRelations = function (record, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        transaction = sequelizeRepository_1["default"].getTransaction(options);
                        _a = output;
                        return [4 /*yield*/, record.getWidgets({
                                transaction: transaction
                            })];
                    case 1:
                        _a.widgets = _b.sent();
    ...
    ReportRepository.prepareSegmentFilter = function (options) {
        var _a, _b;
        return _a = {},
            _a[Op.or] = [
                {
