...
exports["default"] = (function (object, key) {
    var objectWithoutKeys;
    if (typeof key === 'string') {
        var _a = object, _b = key, _ = _a[_b], otherKeys = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
        objectWithoutKeys = otherKeys;
    }
    else if (Array.isArray(key)) {
        objectWithoutKeys = key.reduce(function (acc, i) {
            var _a = acc, _b = i, _ = _a[_b], otherKeys = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
            acc = otherKeys;
            return acc;
        }, object);
    }
