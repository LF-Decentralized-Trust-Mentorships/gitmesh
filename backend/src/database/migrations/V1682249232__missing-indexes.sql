...
create index "ix_signalsContents_tenantId" on "signalsContents" ("tenantId");

create index "ix_signalsActions_tenantId" on "signalsActions" ("tenantId");
create index "ix_signalsActions_actionById" on "signalsActions" ("actionById");
create index "ix_signalsActions_contentId" on "signalsActions" ("contentId");
