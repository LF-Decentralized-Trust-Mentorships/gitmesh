...
--
-- Name: signalsContents; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.settings (
    ...
    "attributeSettings" jsonb DEFAULT '{"priorities": ["custom", "twitter", "github", "devto", "slack", "discord", "gitmesh"]}'::jsonb NOT NULL,
    "createdAt" timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone NOT NULL,
    "deletedAt" timestamp with time zone,
    "tenantId" uuid NOT NULL,
...
--
-- Name: signalsContents signalsContents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signalsContents"
    ADD CONSTRAINT "signalsContents_pkey" PRIMARY KEY (id);
...
--
-- Name: signals_contents_import_hash_tenant_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX signals_contents_import_hash_tenant_id ON public."signalsContents" USING btree ("importHash", "tenantId") WHERE ("deletedAt" IS NULL);


--
-- Name: signals_contents_platform_tenant_id_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX signals_contents_platform_tenant_id_timestamp ON public."signalsContents" USING btree (platform, "tenantId", "timestamp") WHERE ("deletedAt" IS NULL);


--
-- Name: signals_contents_status_tenant_id_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX signals_contents_status_tenant_id_timestamp ON public."signalsContents" USING btree (status, "tenantId", "timestamp") WHERE ("deletedAt" IS NULL);


--
-- Name: signals_contents_tenant_id_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX signals_contents_tenant_id_timestamp ON public."signalsContents" USING btree ("tenantId", "timestamp") WHERE ("deletedAt" IS NULL);
...
--
-- Name: signalsContents signalsContents_createdById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signalsContents"
    ADD CONSTRAINT "signalsContents_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: signalsContents signalsContents_tenantId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signalsContents"
    ADD CONSTRAINT "signalsContents_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES public.tenants(id) ON UPDATE CASCADE;


--
-- Name: signalsContents signalsContents_updatedById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signalsContents"
    ADD CONSTRAINT "signalsContents_updatedById_fkey" FOREIGN KEY ("updatedById") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL;
