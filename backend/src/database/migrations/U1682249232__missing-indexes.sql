...
drop index "ix_signalsContents_tenantId";

drop index "ix_signalsActions_tenantId";
drop index "ix_signalsActions_actionById";
drop index "ix_signalsActions_contentId";
