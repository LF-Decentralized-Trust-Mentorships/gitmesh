...
import { Unleash, getUnleashClient } from '@gitmesh/feature-flags'
import { Edition, SegmentData } from '@gitmesh/types'
import { SERVICE, Error400 } from '@gitmesh/common'
import { Client as TemporalClient, getTemporalClient } from '@gitmesh/temporal'
...
export default class SequelizeRepository {
  ...
  static async commitTransaction(transaction) {
    if (
      transaction.gitmeshNestedTransactions !== undefined &&
