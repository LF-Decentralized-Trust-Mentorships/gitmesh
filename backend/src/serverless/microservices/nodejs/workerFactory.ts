...
async function workerFactory(event: NodeMicroserviceMessage): Promise<any> {
  ...
  switch (service.toLowerCase()) {
    ...
    case 'signals-email-digest':
      ...
      const signalsDigestMessage = event as SignalsEmailDigestMessage
      return signalsEmailDigestWorker(signalsDigestMessage.user, signalsDigestMessage.tenant)
