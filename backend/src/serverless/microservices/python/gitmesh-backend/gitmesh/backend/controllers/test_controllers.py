from gitmesh.backend.controllers import ActivitiesController
from gitmesh.backend.controllers import MembersController
from gitmesh.backend.controllers import IntegrationsController
...
def test_upsert_member(api: "Repository"):
    ...
    member_to_upsert = {
        ...
        "username": '{"apis": "jacqueline_love", "discord": "jacqueline_love", "gitmeshUsername": "jacqueline_love"}',
        "type": "member",
        "info": "{}",
        "platform": "github",
        "gitmeshInfo": '{"discord": {"name": "Jacqueline Love", "sample": True}}',
...
def test_add_activity_with_member(api: "Repository"):
    ...
    activity = {
        ...
        "platform": "github",
        "info": "{}",
        "gitmeshInfo": '{"url": "test", "body": "test", "repo": "test", "title": "Client returns different total number of entities in a non-deterministic way", "parent_url": "htest"}',  # noqa
        "isContribution": True,
        "score": 3,
        "sourceId": None,
        "importHash": None,
