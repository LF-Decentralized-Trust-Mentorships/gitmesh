...
exports.OPENSEARCH_INDEX_MAPPINGS = exports.OPENSEARCH_INDEX_SETTINGS = exports.IndexVersions = exports.OpenSearchIndex = void 0;
var OpenSearchIndex;
...
exports.IndexVersions.set(OpenSearchIndex.MEMBERS, 2);
exports.IndexVersions.set(OpenSearchIndex.ACTIVITIES, 2);
exports.IndexVersions.set(OpenSearchIndex.ORGANIZATIONS, 2);
    ...
    dynamic_templates: [
        ...
        // https://opensearch.org/docs/latest/field-types/supported-field-types/date/
        {
            dates: {
                ...
                mapping: {
                    type: 'date',
                    format: 'strict_date_optional_time||strict_date_optional_time_nanos||epoch_millis||yyyy-MM-dd HH:mm:ssXXX||yyyy-MM-dd HH:mm:ssX||yyyy-MM-dd HH:mm:ss.SSS||yyyy-MM-dd HH:mm:ss.SS||yyyy-MM-dd HH:mm:ss.S||yyyy-MM-dd HH:mm:ss.SSSZ',
                },
            },
        },
        {
...
exports.OPENSEARCH_INDEX_SETTINGS = {
...
exports.OPENSEARCH_INDEX_MAPPINGS = {
