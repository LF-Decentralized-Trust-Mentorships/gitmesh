...
const activity_sync_service_1 = require("./activity.sync.service");
const member_sync_service_1 = require("./member.sync.service");
const organization_sync_service_1 = require("./organization.sync.service");
class InitService {
    constructor(openSearchService, parentLog) {
        this.openSearchService = openSearchService;
        this.log = (0, logging_1.getChildLogger)('init-service', parentLog);
    }
    async initialize() {
    ...
    async createFakeOrganization() {
        ...
        const prepared = organization_sync_service_1.OrganizationSyncService.prefixData(fakeOrg);
        await this.openSearchService.index(`${InitService.FAKE_ORGANIZATION_ID}-${InitService.FAKE_SEGMENT_ID}`, types_1.OpenSearchIndex.ORGANIZATIONS, prepared);
    }
    async createFakeMember() {
        ...
        const prepared = member_sync_service_1.MemberSyncService.prefixData(fakeMember, []);
        await this.openSearchService.index(`${InitService.FAKE_MEMBER_ID}-${InitService.FAKE_SEGMENT_ID}`, types_1.OpenSearchIndex.MEMBERS, prepared);
    }
    async createFakeActivity() {
        ...
        const prepared = activity_sync_service_1.ActivitySyncService.prefixData(fakeActivity);
        await this.openSearchService.index(InitService.FAKE_ACTIVITY_ID, types_1.OpenSearchIndex.ACTIVITIES, prepared);
    }
}
exports.InitService = InitService;
InitService.FAKE_TENANT_ID = 'b0e82a13-566f-40e0-b0d0-11fcb6596b0f';
InitService.FAKE_SEGMENT_ID = 'ce36b0b0-1fc4-4637-955d-afb8a6b58e48';
InitService.FAKE_MEMBER_ID = '9c19e17c-6a07-4f4c-bc9b-ce1fdce9c126';
InitService.FAKE_ACTIVITY_ID = 'fa761640-f77c-4340-b56e-bdd0936d852b';
InitService.FAKE_CONVERSATION_ID = 'cba1758c-7b1f-4a3c-b6ff-e6f3bdf54c86';
InitService.FAKE_ORGANIZATION_ID = 'cba1758c-7b1f-4a3c-b6ff-e6f3bdf54c85';
