export declare enum AutomationSyncTrigger {
 ...
 */
export declare enum AutomationExecutionState {
    SUCCESS = "success",
    ERROR = "error"
}
/**
 ...
 */
export type AutomationSettings = WebhookSettings | NewActivitySettings | NewMemberSettings | HubspotSettings;
