export declare enum SignalsActionType {
    THUMBS_UP = "thumbs-up",
...
export declare enum SignalsEmailDigestFrequency {
    DAILY = "daily",
    WEEKLY = "weekly"
}
...
export declare enum SignalsPlatforms {
    GITHUB = "github",
...
export declare enum SignalsPublishedDates {
