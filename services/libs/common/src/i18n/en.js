...
const en = {
    ...
    errors: {
        ...
        missingScopes: {
            message: 'Missing scopes in {integration}: {scopes}. This is probably due to an outdated version of the integration. Please reinstall and try again.',
        },
        validation: {
        ...
        signals: {
            ...
            keywordsMissing: 'Either keywords or exactKeywords are required in feeds. Settings not updated.',
            platformMissing: 'feed.platforms is required and must be a non-empty list. Settings not updated.',
            platformInvalid: `feed.platforms contains {0}, which is not in [{1}]. Settings not updated.`,
            publishedDateMissing: 'feed.publishedDate is missing or invalid. It should be one of [{0}]. Settings not updated.',
            emailInvalid: 'emailDigest.email needs a valid email address. Settings not updated.',
            frequencyInvalid: 'emailDigest.frequency needs to be one of daily, weekly. Settings not updated.',
        ...
        sentiment: {
            ...
            label: "Invalid sentiment data. The 'label' property must exist and be one of 'positive' | 'negative' | 'mixed' | 'neutral'.",
        ...
        linkedin: {
            ...
            cantOnboardWrongStatus: 'Can not trigger nboarding because integration is not in state pending-action!',
    ...
    entities: {
        ...
        signals: {
            errors: {
                planLimitExceeded: 'Signals is only available in the Growth and Custom plans. Please upgrade your plan.',
            },
        },
    },
    communityHelpCenter: {
    ...
    enrichment: {
        errors: {
            planLimitExceeded: 'You have exceeded # of member enrichments you can have per month in your plan.',
            requestedEnrichmentMoreThanLimit: 'You have requested more member enrichments than your available limit.',
            enrichmentFailed: 'Failed to call the enrichment API',
            noGithubHandleOrEmail: 'No GitHub handle or email found. We can only enrich profiles with GitHub handles or emails.',
            memberNotFound: 'Member not found in the enrichment database. This did not affect your quota.',
        },
    },
};
exports.default = en;
