import { BatchProcessor } from '@gitmesh/common'
...
import { SEARCH_SYNC_WORKER_QUEUE_SETTINGS, SqsClient, SqsQueueReceiver } from '@gitmesh/sqs'
import { IQueueMessage, SearchSyncWorkerQueueMessageType } from '@gitmesh/types'
